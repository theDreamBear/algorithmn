...
class ModeVisitor : public BinaryTreeVisitor {
private:
    unordered_map<int, int> mp;
public:
    ModeVisitor(Order order, void *data) : BinaryTreeVisitor(order, data) {}

protected:
    bool doWhenVisit() override {
        ++mp[currentFrame->node->val];
...
public:
    vector<int> findMode(TreeNode* root) {
        ...
        Data data;
        ModeVisitor visitor(Post_Order, &data);
